            ...
            {({open}) => (
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex justify-between w-full">
                            <div className="flex items-center">
                                <Link href="/">
                                    <h1 className="text-2xl font-medium">Olivier<span className="text-teal-500"> Bergeron</span></h1>
                                </Link>
                            </div>
                            <div className="hidden sm:ml-6 sm:flex sm:space-x-8 sm:items-center">
                                ...
                                :'border-transparent text-gray-500 dark:text-gray-380 dark:hover:text-white hover:text-teal-500 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium'}`} >
                                    Home
                                </Link>
                        ...
                        <div className="-mr-2 flex items-center sm:hidden">
                            ...
                            hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-500 dark:hover:bg-gray-800">
                ...
                <Disclosure.Panel className="sm:hidden">
                    <div className="pt-2 pb-3 space-y-1 ">
                        ...
                        :
                        'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-white hover:text-teal-500 block pl-3 pr-4 py-2 dark:hover:bg-gray-700 border-l-4 text-base font-medium dark:text-white'}`}>
                            Home
                        </Link>
