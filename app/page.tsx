...
export default function Home() {
  return (
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 sl:space-y-0">
       <div className="flex flex-col items-center pt-8">
        <Image src={Me} alt="Picture of Olivier Bergeron" className="h-48 w-48 rounded-full object-cover object-top"/>

        <h3 className="pt-4 pb-2 text-2xl font-bold leading-8 tracking-tight">Olivier Bergeron</h3>  
        <p className="text-gray-500 dark:text-gray-300 text-center">
          Hey my name is Olivier and I am a Full Stack Developer
        </p> 
       ...
       <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
         ...
         <p>Building applications with Reactand sharing them on YouTube is my
            ...
            honing my skills, and inspiring others in the process.</p>
